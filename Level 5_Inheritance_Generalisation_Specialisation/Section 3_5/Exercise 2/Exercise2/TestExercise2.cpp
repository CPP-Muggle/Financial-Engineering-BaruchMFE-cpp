...
{   
	...
	cout<<s.ToString()<<'\n'<<endl;			//Print shape.
	cout<<p.ToString()<<'\n'<<endl;			//Print point. (Testing ToString() method of the base class as well)
	cout<<l.ToString()<<'\n'<<endl;			//print line.  ((Testing ToString() method of the base class as well)) 
	cout<<c.ToString()<<'\n'<<endl;			//print circle.  ((Testing ToString() method of the base class as well)) 
