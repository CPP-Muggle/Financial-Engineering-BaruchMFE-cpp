...
template <typename T>
int Array<T>::default_size = 10;                   // Initialize the staitc data member in the source file.
...
template<typename T>
Array<T>::Array(int a_size)							// Consturctor with one argument
{														
...
template<typename T>
 void Array<T>::DefaultSize(int new_size)      //Set the default_size variable.
{
...
template<typename T>
int Array<T>::DefaultSize()                  // Get default_size variable.
{
		return default_size;
}
